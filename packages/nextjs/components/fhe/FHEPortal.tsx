...
import { Permit } from "@luxfhe/sdk/web";
...
import {
  ...
  useFHEjsAllPermits,
  useFHEjsModalStore,
  useFHEjsRemovePermit,
  useFHEjsSetActivePermit,
  useFHEjsStatus,
} from "~~/app/useFHE";
...
export const FHEPortal = () => {
  ...
  const removePermit = useFHEjsRemovePermit();
    ...
    <details ref={dropdownRef} className="dropdown dropdown-end leading-3">
      ...
      <div className="dropdown-content z-2 p-4 mt-2 shadow-center shadow-accent bg-base-200 rounded-box gap-1 min-w-[275px]">
        <div className="flex flex-row justify-center items-center gap-2 px-2 py-1">
          ...
          <span className="font-bold">FHE Portal</span>
        </div>
        ...
        <div className="flex flex-col gap-1 mt-2">
          ...
          <AllPermitsList />
          <div
            className={`btn btn-sm btn-fhe mt-2 w-full ${!initialized && "btn-disabled"}`}
...
const PermitItem = ({
  ...
  const setActivePermit = useFHEjsSetActivePermit();
    ...
    <div className="flex flex-col bg-base-300/30 p-2 rounded-lg">
      ...
      {!isActive && (
        <div className="flex justify-start gap-2 mt-2">
          <div className="btn btn-xs btn-fhe" onClick={() => setActivePermit(permit.getHash())}>
            Use
          </div>
          <div
